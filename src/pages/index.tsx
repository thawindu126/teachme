            ...
            <div className="relative mx-auto h-[calc(100vh-4rem)] max-w-lg space-y-20 py-44">
              <div className="space-y-14">
                ...
                <div className="text-2xl">
                  The Feynman Technique is considered to be one of the most effective learning techniques out
                  there. It uses a simple 4-step process for understanding any topic or concept quickly and
                  effectively.
                  <br />
                  Try it with us!
                </div>
